...
[![Example](https://img.shields.io/badge/PDF-examples-%23F5A525)](https://www.researchgate.net/publication/410814436_Supplementary_material_Examples_SED2Text)
[![Replicate_results](https://img.shields.io/badge/Zip%20files-Replicate%20_results-green)](https://github.com/Snehitc/SED2Text/releases/tag/prediction_results)
...
* ```
  ...
  Generated Text (flat): ['The audio clip begins with background noise, which gradually becomes more
                  prominent as it builds up over time. The next event is a telephone dialing, followed
